#Author: Nasir Khan
Feature: GF-1161 Preview Event Audience
	As a user in order to submit application
	I should be able preview entered Event audience info.
...
When I  enter "<text>" in "EventAudience"
